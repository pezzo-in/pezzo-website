...
<section class="testimonial-wrap pad-common high-bg">
	...
	<p class="address-text white-text">Identity LLC, North Avenue, London, UK</p>				
						  ...
						  <form name="myform" id="contactForm" class="add-top-half" action="sendcontact.php" enctype="multipart/form-data" method="post"> 
								...
								<article>
								 ...
								 <article>
									...
									<div class="btn-wrap">
										<button class="btn btn-identity-color" id="submit" name="submit" type="submit">Send Message</button>
									</div>
								</article>
						 </form>
					</div>
